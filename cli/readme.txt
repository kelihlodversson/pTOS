EmuCON2 - pTOS console, standalone version

EmuCON2 is a basic but useful command-line interpreter, written from
scratch by Roger Burrows in 2013 to replace the original CLI.
...
Like the rest of pTOS, EmuCON2 is Open Source, so any bugs in it can
be (eventually) fixed.  Unlike the rest of pTOS, it is available only
in English.
