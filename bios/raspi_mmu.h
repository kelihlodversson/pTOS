/*
 * raspi_mmu.h - definitions for setting up an armv6 or v7 mmu
 *
 * Originally from Circle - A C++ bare metal environment for Raspberry Pi
...
{
    ULONG   XNBit   : 1,        /* execute never bit*/
            Value1  : 1,        /* set to 1*/
            BBit    : 1,        /* bufferable bit*/
            CBit    : 1,        /* cacheable bit*/
            AP      : 2,        /* access permissions*/
