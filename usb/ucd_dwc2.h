...
/*
 * DWC2 device driver code originally from u-boot.
...
#ifdef MACHINE_RPI
#include "raspi_io.h"
#define USB_DWC2_REG_ADDR (ARM_IO_BASE+0x980000)
...
struct dwc2_hc_regs {
    uint32_t       hcchar;        /* 0x00 */
    uint32_t       hcsplt;
    uint32_t       hcint;
    uint32_t       hcintmsk;
    uint32_t       hctsiz;        /* 0x10 */
    uint32_t       hcdma;
    uint32_t       reserved;
    uint32_t       hcdmab;
};
...
struct dwc2_core_regs {
    uint32_t       gotgctl;    /* 0x000 */
    uint32_t       gotgint;
    uint32_t       gahbcfg;
    uint32_t       gusbcfg;
    uint32_t       grstctl;    /* 0x010 */
    uint32_t       gintsts;
    uint32_t       gintmsk;
    uint32_t       grxstsr;
    uint32_t       grxstsp;    /* 0x020 */
    uint32_t       grxfsiz;
    uint32_t       gnptxfsiz;
    uint32_t       gnptxsts;
    uint32_t       gi2cctl;    /* 0x030 */
    uint32_t       gpvndctl;
    uint32_t       ggpio;
    uint32_t       guid;
    uint32_t       gsnpsid;    /* 0x040 */
    uint32_t       ghwcfg1;
    uint32_t       ghwcfg2;
    uint32_t       ghwcfg3;
    uint32_t       ghwcfg4;    /* 0x050 */
    uint32_t       glpmcfg;
    ...
    uint32_t       hprt0;        /* 0x440 */
    uint32_t       _pad_0x444_0x4fc[47];
    struct dwc2_hc_regs    hc_regs[16];    /* 0x500 */
    uint32_t       _pad_0x700_0x800[64];
        /* Device Configuration 0x800 */
    ...
    uint32_t       _pad_0x820_0xe00[376];
    uint32_t       pcgcctl;    /* 0xe00 */
};
...
#undef CONFIG_DWC2_DMA_ENABLE
#define CONFIG_DWC2_DMA_BURST_SIZE        4    /* DMA burst len */
...
#define CONFIG_USB_DWC2_BUFFER_SIZE     16

#define DWC2_PHY_TYPE_FS        0
#define DWC2_PHY_TYPE_UTMI        1
#define DWC2_PHY_TYPE_ULPI        2
#define CONFIG_DWC2_PHY_TYPE        DWC2_PHY_TYPE_FS    /* PHY type */
