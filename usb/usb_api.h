...
//    short                (*getfreeunit)        (char *);
    long            (*udd_register)        (struct uddif *);
    long            (*udd_unregister)    (struct uddif *);
    long            (*ucd_register)        (struct ucdif *, struct usb_device **);
    long            (*ucd_unregister)    (struct ucdif *);

    void            (*usb_rh_wakeup)    (void);
    long            (*usb_hub_events)   (struct usb_hub_device *dev);
    ...
    long            (*usb_get_configuration_no)    (struct usb_device *dev, long cfgno, unsigned char *buffer, long length);
...
#if 0 // TODO: API for externally loaded modules
